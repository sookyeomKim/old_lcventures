...
@section('sub')
    <div id="wrap">
        ...
        <!-- 상단 비주얼 영역 시작 -->
        <div id="visual01">
            <p class="sub_slogan01"><img src="../images/sub_slogan01.png"  alt=""></p>
        </div>
        <!-- //상단 비주얼 영역 끝 -->
        ...
        <div id="container">
            ...
            <div class="leftmenu">
                <h2>ABOUT</h2>
                <ul>
                    <li><a class="on" href="../about/about01.html">About us</a></li>
            ...
            <!-- 컨텐츠 영역 시작 -->
            <div class="contents">
                <div class="c_img01"><img src="../images/about01.jpg"  alt="" style="padding:102px 0 55px 0;"></div>
            </div>
            <!-- //컨텐츠 영역 끝 -->
