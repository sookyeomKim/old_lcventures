...
<!-- 상단 비주얼 영역 시작 -->
<div id="visual01">
    <p class="sub_slogan01"><img src="../images/sub_slogan0102.png"  alt=""></p>
</div>
<!-- //상단 비주얼 영역 끝 -->
...
<div id="container">
    ...
    <div class="leftmenu">
        ...
        <ul>
            ...
            <li><a class="on" href="{{url('page/ceoIntro')}}">Message to client</a></li>
    ...
    <!-- 컨텐츠 영역 시작 -->
    <div class="contents">
        <div class="l_img01"><img src="../images/about02.jpg"  alt="" style="padding:103px 0 122px 62px;"></div>
        <p style="position:absolute; bottom:0; right:-11px; z-index:9; font-size:0; line-height:0;"><img src="../images/about0202.png"  alt=""></p>
    </div>
    <!-- //컨텐츠 영역 끝 -->
