...
@section('sub')
    <div id="wrap">
        ...
        <!-- 상단 비주얼 영역 시작 -->
        <div id="visual01">
            <p class="sub_slogan01"><img src="../images/sub_slogan0202.png"  alt=""></p>
        </div>
        <!-- //상단 비주얼 영역 끝 -->
        ...
        <div id="container">
            ...
            <div class="contents">
                <div class="tab">
                    <ul>
                        <li><a href="{{url('page/intergratedMarketing')}}"><img src="../images/tab_work0201_on.gif"  alt="" ></a></li>
                        <li><a href="{{url('page/curationMarketing')}}"><img src="../images/tab_work0202_off.gif"  alt="" ></a></li>
                        <li><a href="{{url('page/InternalConsulting')}}"><img src="../images/tab_work0203_off.gif"  alt="" ></a></li>
                    </ul>
                </div>
                <div class="l_img01"><img src="../images/work0201_01.jpg"  alt="" style="padding:50px 0 0 61px;"></div>
                <div class="l_img01"><img src="../images/work0201_02.jpg"  alt="" style="padding:50px 0 0 61px;"></div>
            </div>
            <!-- //컨텐츠 영역 끝 -->
