            ...
            <div class="contents">
                <div class="tab">
                    <ul>
                        ...
                        <li><a href="{{url('page/networkAd')}}"><img src="../images/tab_work0304_on.gif"  alt="" ></a></li>
                    </ul>
                </div>
                <div class="l_img01"><img src="../images/work0304_01.jpg"  alt="" style="padding:50px 0 0 61px;"></div>
                <div class="l_img01"><img src="../images/work0304_02.jpg"  alt="" style="padding:50px 0 0 61px;"></div>
            </div>
            <!-- //컨텐츠 영역 끝 -->
