<?php
  // 올앳관련 함수 Include
  //----------------------
  include "./AllatPayBasic_PHP/allatutil.php";
...
<head>
    ...
    <script type="text/javascript" src="../lc/js/jquery-1.9.1.min.js"></script>

</head>

<body style="background:#fff;"><div id="wrap" style="width:677px; height:665px;">

	<div class="payArea">
        <div class="formArea">
            <p class="txt01">결제내역</p>
            <p class="img001"><img src="images/logo01.gif"  alt=""></p>
        </div>
        <div class="paytable">
			<?
				if( !strcmp($REPLYCD,"0000") )
